    ...
    return (
        <div className="contact-container">
            ...
            <div className="links-container">
                <Link to='https://github.com/vosse'><img className='link-icon' src={require('../assets/github-white.png')}/></Link>
                <Link to='https://www.linkedin.com/in/relja-jovicevic-7a3222173/'><img className='link-icon' src={require('../assets/linkedin-white.png')}/></Link>
            </div>
        </div>
    )
}